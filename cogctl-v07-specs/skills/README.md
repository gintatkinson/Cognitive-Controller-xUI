...
This toolchain operates on a **Master-Worker architecture** requiring four distinct skills:

### 1. `spec-orchestrator` (The Master)
The overarching command-and-control skill. You assign this skill to your primary AI agent. It is responsible for triggering the three worker skills in sequence and enforcing strict validation gates (verifying GitHub issues actually exist before proceeding).
...
1. Ensure your AI agent has access to this `/docs/skills/` directory.
